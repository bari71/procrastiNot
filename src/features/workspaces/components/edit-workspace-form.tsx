...
export const EditWorkspaceForm = ({ onCancel, initialValues }: editWorkspaceForm) => {
    ...
    const [ResetDialog, confirmReset] = useConfirm('Reset Invite Link', 'Are you sure you want to reset the invite link? This action cannot be undone.', 'destructive');
            ...
            <Card className="w-full h-full border-none shadow-none">
                <CardContent className="p-7">
                    <div className="flex flex-col">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Deleting your workspace will remove all associated data and cannot be undone.
                        </p>
                        <Separator className='mt-7'/>
                        <Button
                            className="mt-6 w-fit ml-auto"
